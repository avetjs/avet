...
exports._rewriteUrlForAvetExport = _rewriteUrlForAvetExport;
...
function throwIfNoRouter() {
  if (!SingletonRouter.router) {
    var message = 'No router instance found.\n' + 'You should only use "avet/router" inside the client side of your app.\n';
...
function _rewriteUrlForAvetExport(url) {
