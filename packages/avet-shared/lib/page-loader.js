...
var _eventEmiiter = require('./event-emiiter');

var _eventEmiiter2 = _interopRequireDefault(_eventEmiiter);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var webpackModule = module; /* global window, document, __AVET_DATA__ */
...
var PageLoader = function () {
  function PageLoader(buildId, assetPrefix) {
    ...
    this.pageRegisterEvents = new _eventEmiiter2.default();
    this.loadingRoutes = {};

    this.chunkRegisterEvents = new _eventEmiiter2.default();
    this.loadedChunks = {};
  }
  ...
  (0, _createClass3.default)(PageLoader, [{
    ...
    value: function loadScript(route) {
      ...
      var url = this.assetPrefix + '/_avet/' + encodeURIComponent(this.buildId) + '/page' + route;
      script.src = url;
    ...
    key: 'waitForChunk',
    value: function waitForChunk(chunkName) {
      var _this4 = this;
    ...
    value: function clearCache(route) {
      ...
      var script = document.getElementById('__AVET_PAGE__' + route);
      if (script) {
